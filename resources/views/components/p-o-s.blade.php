                    ...
                    <div class="bg-white dark:bg-neutral-800 rounded-2xl shadow-lg overflow-hidden
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-sm text-gray-700 dark:text-gray-300 mt-1 font-bold">
                                {{ Number::currency(number_format($item->price, 2), $currency) }}
                            </p>
                        </div>
            ...
            @forelse($this->cart as $cartItem)
                <div class="flex items-center justify-between p-4 mb-4 bg-gray-50 dark:bg-neutral-700 rounded-xl shadow-sm">
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">{{ Number::currency(number_format($cartItem['price'], 2), $currency) }} each</p>
                    </div>
        ...
        <div class="shrink-0 mt-6 space-y-4">
            ...
            <div class="mt-6 pt-6 border-t border-gray-200 dark:border-neutral-700">
                <div class="flex justify-between items-center mb-2">
                    <span class="text-sm text-gray-600 dark:text-gray-400">Subtotal:</span>{{ Number::currency(number_format($this->subtotal, 2), $currency) }}</span>
                </div>
                <div class="flex justify-between items-center mb-2">
                    <span class="text-sm text-gray-600 dark:text-gray-400">Tax ({{$tax_rate}}%):</span>
                    <span class="font-medium text-gray-800 dark:text-gray-100">{{ Number::currency(number_format($this->tax, 2), $currency) }}</span>
                </div>
                <div class="flex justify-between items-center mb-2">
                    <span class="text-sm text-gray-600 dark:text-gray-400">Total before discount:</span>
                    <span class="font-medium text-gray-800 dark:text-gray-100">{{ Number::currency(number_format($this->totalBeforeDiscount, 2), $currency) }}</span>
                </div>
